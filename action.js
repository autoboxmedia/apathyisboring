...
$(document).ready(function() {
  ...
  // This piece of code is meant for the follow / unfollow actions of users.
  // It keeps tabs on ajax requests to NB, and if they are for follow/unfollow of
  // profiles, it adds/removes classes to the post/delete buttons that activate the
  // ajax calls to show/hide the respective icons for following unfollowing.
